import type { Request as ExpressRequest, Request } from 'express';
import { Dictionary, isString, mapKeys, pickBy } from 'lodash';
import { transformFilter } from './transformQuery';
...
export const Paginate = (request: Request): PaginateQuery => {
    request.query = transformFilter(request.query);
