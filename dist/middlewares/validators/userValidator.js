...
exports.userCreationValidatorStepOne = [
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            return [
                                4 /*yield*/,
                                accountRepository_1.AccountRepository.findOneBy(
                                    { email: val },
                                ),
                            ];
                        case 1:
    ...
    (0, express_validator_1.body)('confirmPassword').custom(
        function (value, _a) {
            var req = _a.req;
...
exports.userCreationValidatorStepTwo = [
    ...
    (0, express_validator_1.body)('phone.countryCode')
        ...
        .custom(function (value) {
            if (value in countryCode_1.CountryCode) return value;
    ...
    (0, express_validator_1.body)('address.country')
        ...
        .custom(function (value) {
            if (value in country_1.Country) return value;
            else
                throw new Error(
    ...
    (0, express_validator_1.body)('experience.*.employmentType')
        ...
        .custom(function (value) {
            if (value in employmentType_1.EmploymentType) return value;
    ...
    (0, express_validator_1.body)('experience.*.locationType')
        ...
        .custom(function (value) {
            if (value in locationType_1.LocationType) return value;
    ...
    (0, express_validator_1.body)('languages.*')
        ...
        .custom(function (value) {
            if (value in language_1.Language) return value;
...
exports.resetPasswordValidator = [
    (0, express_validator_1.body)('newPassword')
        .isLength({ min: 8 })
        .withMessage('Password must be at least 8 characters long'),
    (0, express_validator_1.body)('newPasswordConfirm').custom(
        function (value, _a) {
            var req = _a.req;
