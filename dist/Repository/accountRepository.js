...
var AccountRepositoryClass = /** @class */ (function (_super) {
    ...
    AccountRepositoryClass.prototype.findAllAccountData = function (accountId) {
        return __awaiter(this, void 0, void 0, function () {
            var account;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.createQueryBuilder('account')
...
exports.AccountRepository = data_source_1.AppDataSource.getRepository(Account_1.Account).extend(AccountRepositoryClass.prototype);
